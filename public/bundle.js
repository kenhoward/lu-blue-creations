...
/***/ function(module, exports, __webpack_require__) {
	...
	ReactDOM.render(React.createElement(
	  ...
	  null,
	  routes
	), document.getElementById('lublue'));
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          "a",
	          { href: "https://www.pinterest.com/lubluecreations/", target: "_blank" },
	          React.createElement("i", { className: "fa fa-pinterest-square fa-2x" })
	        ),
	        React.createElement(
	          "a",
	          { href: "https://www.instagram.com/lubluecreations/", target: "_blank" },
	          React.createElement("i", { className: "fa fa-instagram fa-2x" })
	        ),
	        React.createElement(
	          "a",
	          { href: "https://twitter.com/lubluecreations", target: "_blank" },
	          React.createElement("i", { className: "fa fa-twitter-square fa-2x" })
	        ),
	        React.createElement(
	          "a",
	          { href: "https://www.facebook.com/lubluecreations/", target: "_blank" },
	          React.createElement("i", { className: "fa fa-facebook-square fa-2x" })
	        )
	      ),
	      React.createElement(
	        "div",
	        { className: "logo" },
	        React.createElement("img", { src: "images/lu_blue_logo.jpg" })
	      ),
	      React.createElement(
	        "nav",
	        { className: "navbar navbar-default", role: "navigation", id: "lublue-nav" },
	        React.createElement(
	          "div",
